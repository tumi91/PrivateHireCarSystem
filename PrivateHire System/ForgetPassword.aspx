<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForgetPassword.aspx.cs" Inherits="PrivateHire_System.ForgetPassword" %>
				...
				<form>
					<div class="input-group form-group">
                      ...
                      <asp:Label ID="Label1" runat="server" Text="What is your First Pet?" style="color: #FFFFFF"></asp:Label>
						...
						<asp:TextBox ID="TextBox2" class="form-control" runat="server" placeholder="Answer" />
					</div>
